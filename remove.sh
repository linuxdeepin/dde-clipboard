...
rm ./dde-clipboard/*.o
rm ./dde-clipboard/moc_*
rm ./dde-clipboard/Makefile*
rm ./dde-clipboard/dde-clipboard

rm ./dde-clipboardloader/*.o
rm ./dde-clipboardloader/moc_*
rm ./dde-clipboardloader/Makefile*
rm ./dde-clipboardloader/dde-clipboardloader
